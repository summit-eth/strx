var CONTRACT_ADDRESS = "TDZqPcxxH3nmYsmfMCE2Pkkgd4gu9tVVFJ";
var SOFT_LAUNCH = 1610236800; 
var FULL_LAUNCH = 1610280000; 
...
document.addEventListener('DOMContentLoaded', function(){
  window.referral = 'TC7A9ik45uq3j34Ruc82bYN7gCa4NpEYhz';
  ...
  var load_obj = setInterval(async ()=>{
      if (window.tronWeb && window.tronWeb.defaultAddress.base58) {
        ...
        document.getElementById("referral_link").value = "https://supreme-trx.online?r="+window.tronified.address;
  ...
  document.getElementById("withdraw").addEventListener('click', async (e)=>{
    e.preventDefault();
    window.hypertron.contract.withdraw().send()
...
function copyText(value) {
	...
	try {
		...
		swal('Link copied to clipboard', 'Link Copied', 'success');
	} catch (err) {}
...
function copyLink() {
	var s = document.getElementById("referral_link");
	copyText(s.value);
